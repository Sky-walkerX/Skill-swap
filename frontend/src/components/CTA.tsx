...
import { ArrowRight, CheckCircle, Users, Star, Globe, Sparkles, Mail, Lock, Heart, Award } from "lucide-react"
            ...
            >
              <div className="mb-8">
                ...
                <p className="text-xl text-stone-200 mb-10 leading-relaxed">
                  Join thousands of professionals who are already growing their skills and expanding their networks
                  through meaningful exchanges. Your next opportunity awaits.
                </p>
              </div>
                    ...
                    {!isSubmitted ? (
                      ...
                      >
                        <div className="text-center mb-8">
                          ...
                          <h3 className="text-3xl font-bold text-stone-900 mb-3">Start Your Journey</h3>
                          <p className="text-stone-600 text-lg leading-relaxed">
                            Create your free account and get matched with your first skill exchange partner within 24
                            hours
                          </p>
                        </div>
                        ...
                        <div className="mt-8 text-center">
                          ...
                          <p className="text-xs text-stone-400 leading-relaxed">
                            By signing up, you agree to our Terms of Service and Privacy Policy. No spam, unsubscribe
                            anytime.
                          </p>
                        </div>
                      </motion.div>
                      ...
                      >
                        ...
                        <h3 className="text-3xl font-bold text-stone-900 mb-4">Welcome to SkillShare Connect!</h3>
                        <p className="text-stone-600 mb-8 text-lg leading-relaxed">
                          Check your email to complete your account setup and start connecting with skill exchange
                          partners in your area.
                        </p>

                        <div className="flex items-center justify-center gap-2 mb-6">
                          <Award className="h-5 w-5 text-amber-500" />
                          <span className="text-stone-600">You've earned your first badge: Community Member</span>
                        </div>
