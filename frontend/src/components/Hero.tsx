        ...
        <div className="text-center max-w-5xl mx-auto">
          ...
          >
            <div className="inline-flex items-center gap-2 bg-sage-100 dark:bg-sage-800 px-4 py-2 rounded-full mb-6">
              ...
              <span className="text-sage-700 dark:text-sage-300 font-medium">Where Skills Meet Opportunity</span>
            </div>
          ...
          >
            Join a community where knowledge flows freely. Exchange your expertise, learn new skills, and forge
          ...
          >
            {[
              ...
              >
                ...
                <div className="text-sm text-stone-600 dark:text-stone-400 font-medium">{stat.label}</div>
              </motion.div>
            ))}
          </motion.div>
        </div>
