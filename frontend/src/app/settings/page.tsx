              ...
              <CardContent className="space-y-4">
                <div className="flex items-center justify-between">
                  <div>
                    ...
                    <p className="text-sm text-muted-foreground">When someone wants to swap skills with you</p>
                  </div>
                  <Button
                    variant={notificationSettings.swapRequests ? "default" : "outline"}
                    size="sm"
                ...
                <div className="flex items-center justify-between">
                  <div>
                    ...
                    <p className="text-sm text-muted-foreground">When someone rates your skills</p>
                  </div>
                  <Button
                    variant={notificationSettings.ratings ? "default" : "outline"}
                    size="sm"
              ...
              <CardContent className="space-y-4">
                ...
                <div className="flex items-center justify-between">
                  <div>
                    ...
                    <p className="text-sm text-muted-foreground">Let others send you swap requests</p>
                  </div>
                  <Button
                    variant={privacySettings.allowSwapRequests ? "default" : "outline"}
                    size="sm"
