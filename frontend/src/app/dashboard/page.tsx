              ...
              <CardContent>
                <div className="space-y-4">
                  {swapRequests.slice(0, 5).map((request) => {
                    ...
                    return (
                      <div key={request.swapId} className="flex items-center space-x-4 p-3 border border-border rounded-lg">
                        <Avatar
                        ...
                        <div className="flex-1">
                          ...
                          <p className="text-sm text-muted-foreground">
                            for {request.wantedSkill.name} • {new Date(request.createdAt).toLocaleDateString()}
                          </p>
                        </div>
                        <Badge 
                          variant={
          ...
          <div className="space-y-6">
              ...
              <CardContent>
                <div className="space-y-3">
                  {notifications.slice(0, 3).map((notification) => (
                    <div key={notification.notificationId} className="flex items-start space-x-3">
            ...
            <Card>
              ...
              <CardContent>
                <div className="space-y-3">
                  <div>
                    <h4 className="text-sm font-medium mb-2">Skills Offered ({user.skillsOffered.length})</h4>
                  ...
                  <div>
                    <h4 className="text-sm font-medium mb-2">Skills Wanted ({user.skillsWanted.length})</h4>
                    <div className="flex flex-wrap gap-1">
        ...
        <Card className="mt-8">
          ...
          <CardContent>
            <div className="grid grid-cols-2 md:grid-cols-4 lg:grid-cols-6 gap-4">
              {['JavaScript', 'Cooking', 'Photography', 'Spanish', 'Guitar', 'Yoga'].map((skill) => (
                <div key={skill} className="text-center p-3 border border-border rounded-lg hover:border-primary/50 transition-colors cursor-pointer">
