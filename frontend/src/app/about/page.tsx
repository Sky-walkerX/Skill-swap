      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <div className="text-center mb-16">
          ...
          <p className="text-xl text-muted-foreground max-w-3xl mx-auto mb-8">
            ...
            with those who can teach them. We believe that everyone has something valuable 
            to share and something new to learn.
          </p>
        ...
        <div className="mb-16">
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 lg:grid-cols-6 gap-4">
            {[
              'JavaScript', 'Cooking', 'Photography', 'Spanish', 
              'Guitar', 'Yoga', 'Python', 'Graphic Design',
              'Chess', 'Woodworking', 'French', 'Piano'
            ].map((skill) => (
              <div key={skill} className="text-center p-4 border border-border rounded-lg hover:border-primary/50 transition-colors">
              ...
              <CardContent className="space-y-3">
                ...
                <div className="flex items-start space-x-3">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-muted-foreground">
                      If something feels wrong, don&apos;t proceed with the exchange
                    </p>
                  </div>
                </div>
              </CardContent>
